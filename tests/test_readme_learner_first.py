...
def test_existing_gallery_and_star_chart_preserved():
...
def test_technical_reference_remains_accessible():
    text=Path("README.md").read_text(encoding="utf-8")
    for heading in ["Installation","Run Artifacts","MCP Reference","REST API","Configuration","Testing","Repository Layout","License"]:
